...
public class CaptureTextToTranslateFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.fragment_capture_to_translate, container,false);
		return root;
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		captureBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				fragmentTransaction.replace(R.id.fragment_container, translateTextFragment);
	...
	private void startCameraSource() {
		...
		if (!textRecognizer.isOperational()) {
			Log.w("CaptureTextToTranslate", "Text detector dependencies have not yet been loaded");
		} else {
			...
			textRecognizer.setProcessor(new Detector.Processor<TextBlock>() {
				...
				/**
				 * Detect the text from the scene using TextBlock and append the values into a StringBuilder
				 * Convert it to a string and set the text of the TextView
				 * */
				@Override
